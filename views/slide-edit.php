			...
			<label class="cs-slide-hidden" for="cs-slide-hidden-<?php echo $i; ?>">
				...
				<span><?php _e('Hide', 'cycloneslider'); ?></span>
                     ...
                     <!-- added for Nationality selector-->
                        <div >
				<div >
					<label for=""><?php _e('RelevantNations', 'cycloneslider'); ?></label>
					<textarea class="widefat cs-testimonial" name="cycloneslider_metas[<?php echo $i; ?>][testimonial_nations]"><?php echo esc_textarea($slide['testimonial_nations']); ?></textarea>
				</div>
			</div><!-- // end .cs-testimonial-quote --> <!-- -! Nationality selector -->
		</div>
		<div class="clear"></div>
